...
class FullStackSearchComponent extends React.Component<object, JobSearchState> {
    ...
    async componentDidMount() {
        const options = {
            ...
            params: {
                query: 'fullstack developer jobs in houston',
                page: '1',
                num_pages: '1',
                country: 'us',
                date_posted: 'all'
    ...
    render() {
        ...
        return (
            <div className="job-listings">
                <h2>Houston FullStack Job listings</h2>
...
const FullStackSearch = FullStackSearchComponent;

export { FullStackSearch };
